...
public class XMLRPCClient
{
    ...
    */
   public static final int FLAGS_SSL_IGNORE_ERRORS = FLAGS_SSL_IGNORE_INVALID_CERT | FLAGS_SSL_IGNORE_INVALID_HOST;
    ...
    */
   public static final int FLAGS_APACHE_WS = FLAGS_IGNORE_NAMESPACES | FLAGS_NIL | FLAGS_DEFAULT_TYPE_STRING;
   ...
   /**
    * create_and_prepare a new XMLRPC client for the given URL.
    *
   ...
   public XMLRPCClient(URL url, String userAgent, int flags)
   {
      ...
      this.flags = flags;
      // create_and_prepare a parser for the http responses.
   ...
   /**
    * create_and_prepare a call object from a given method string and parameters.
    *
   ...
   private class Caller extends Thread
   {
      ...
      /**
       * create_and_prepare a new Caller for asynchronous use.
       *
      ...
      /**
       * create_and_prepare a new Caller for synchronous use.
      ...
      public Object call(String methodName, Object[] params) throws XMLRPCException
      {
         ...
         try
         {
            ...
            {
               // Due to a bug on android, the get_response_code()-method will
            ...
            if (!isFlagSet(FLAGS_IGNORE_STATUSCODE) && statusCode != HttpURLConnection.HTTP_OK)
            {
